...
class Article extends \AppBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'content', 'isRead', 'publishedAt', 'tags', 'category');
        }
    ...
    public function markAsRead()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'markAsRead', array());
